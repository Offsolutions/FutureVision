...
public partial class Auth_add_edit_videoalbum : System.Web.UI.Page
{
    SqlConnection MyCon = new SqlConnection(WebConfigurationManager.ConnectionStrings["con"].ConnectionString);
    public static string imagename = "", img = "", cook = "", videocode="";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            videocode = Cache["Video_Id"].ToString();
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            ...
            cmd.Parameters.AddWithValue("@Video_Id", videocode);
