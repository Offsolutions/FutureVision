...
public partial class Auth_add_edit_album : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdateAlbum", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertAlbum", MyCon);
    ...
    public void BindData()
    {
        if (cook != "" && cook != null)
        {
            SqlCommand cmd = new SqlCommand("AlbumByid", MyCon);
            cmd.CommandType = CommandType.StoredProcedure;
