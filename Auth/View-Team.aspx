<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="View-Team.aspx.cs" Inherits="Auth_View_Team" %>
    ...
    <Columns>
        ...
        <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
           ...
           <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("Designation")%></div>
                </ItemTemplate>
