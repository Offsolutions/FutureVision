...
public partial class Auth_view_logo : System.Web.UI.Page
{
    ...
    protected void gridlist_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "edit")
        {
            ...
            Response.Redirect("add-edit-logo.aspx");
        }
        if (e.CommandName == "Activate")
        {
            string cmd1 = "update tblLogo set Status='1' where id=" + e.CommandArgument;
        ...
        {
            string cmd1 = "update tblLogo set Status='0' where id=" + e.CommandArgument;
            SqlCommand cmd = new SqlCommand(cmd1, MyCon);
            MyCon.Open();
            cmd.ExecuteNonQuery();
            MyCon.Close();
