...
public partial class Auth_add_edit_page : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdatePage", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertPage", MyCon);
        ...
        cook = "";
        Cache.Remove("Val");
        Response.Redirect("View-page.aspx");
    }
    #endregion
    #region Resize Image
