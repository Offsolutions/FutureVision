<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="View-category.aspx.cs" Inherits="Auth_View_category" %>
...
<div class="col-lg-12">
      <div class="up-lay griddesign">
        <div class="col-md-8">
            <h2 class="up-name">View Category</h2>
        </div>
    ...
    <Columns>
            <asp:TemplateColumn >
             ...
             <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("Cat_name")%></div>
                </ItemTemplate>
