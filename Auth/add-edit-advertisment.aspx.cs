...
public partial class Auth_add_edit_advertisment : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (sliderimage.HasFile)
        {
            ...
            imagename = "ADV" + "_" + GenerateClassCode() + "_" + sliderpic;
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("Updateadv", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertadv", MyCon);
        ...
        cook = "";
        Cache.Remove("Val");
        Response.Redirect("View-adv.aspx");
    }
    #endregion
    #region Resize Image
