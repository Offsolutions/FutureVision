...
public partial class Auth_add_edit_service : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            objsql.BindDropDownList("select Cat_name,Id from tblCategory", "Cat_name", "Id", ddltype);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        string p = Common.Get(objsql.GetSingleValue("select priority from tblService where priority='" + txtpre.Text + "' and Type='"+ddltype.SelectedItem.Text+"'"));
        if (p == "")
        {
            goto ss;
        }
