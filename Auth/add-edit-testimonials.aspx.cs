...
public partial class Auth_add_edit_testimonials : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdateTestimonial", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertTestimonial", MyCon);
        ...
        cook = "";
        Cache.Remove("Val");
        Response.Redirect("View-testimonials.aspx");
    }
    #endregion
    #region Resize Image
    ...
    public void BindData()
    {
        if (cook != "" && cook != null)
        {
            SqlCommand cmd = new SqlCommand("TestimonialByid", MyCon);
            cmd.CommandType = CommandType.StoredProcedure;
