<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="view-achiever.aspx.cs" Inherits="Auth1_view_achiever" %>
...
<asp:DataGrid ID="gridlist" runat="server" Width="100%" AutoGenerateColumns="false" 
    ...
    <Columns>
            ...
            <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("Band")%></div>
            ...
            <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     ...
                     <div style=" text-align:center"><image src="../uploadimage/<%#Eval("Image") %>" width="100px" /></div>
