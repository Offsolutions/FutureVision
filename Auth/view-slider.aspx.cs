...
public partial class Auth_view_slider : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        ds = objsql.GetDataset("select * from tblslider");
    ...
    protected void gridlist_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "edit")
        {
            ...
            Response.Redirect("add-edit-slider.aspx");
        }
        if (e.CommandName == "Activate")
        {
            string cmd1 = "update tblSlider set Status='1' where id=" + e.CommandArgument;
        ...
        {
            string cmd1 = "update tblSlider set Status='0' where id=" + e.CommandArgument;
            SqlCommand cmd = new SqlCommand(cmd1, MyCon);
            MyCon.Open();
            cmd.ExecuteNonQuery();
            MyCon.Close();
