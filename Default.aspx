...
<div class="navbar navbar-default" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header" style="    height: 121px;">
            ...
            <a href="Default.aspx" class="navbar-brand"><img src="assets/images/logo.png" alt="" width="210"></a>
        </div>
            </div>
        <div class="col-md-9">
                            ...
                            <div class="ti_slide">
                                <div class="ti_content">
                                    <asp:ListView ID="lvnews" runat="server">
                                        ...
                                        <a href="#"><span></span> <%#Eval("Description") %></a></div> | 
                                        </ItemTemplate>
                                    </asp:ListView>
                                ...
                                <asp:ListView ID="lvslider" runat="server">
                                    <ItemTemplate>
                                        <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                                            <img src='uploadimage/<%#Eval("Image") %>' data-fullwidthcentering="on" alt="slide">
                                            <div class="tp-caption first-line lft tp-resizeme start" data-x="left" data-hoffset="0" data-y="190" data-speed="1000" data-start="200" data-easing="Power4.easeOut" data-splitin="none" data-splitout="none" data-elementdelay="0" data-endelementdelay="0">
								...
								<div class="row">
									<div class="col-md-12">
										<div id="owl-testimonials" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
											<div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 2220px; left: 0px; display: block; transition: all 800ms ease; transform: translate3d(-555px, 0px, 0px);">
    ...
    <div class="container">
        <div id="owl-example" class="owl-carousel">
            <asp:ListView ID="Listlogo" runat="server">
                <ItemTemplate>
                      <div> <img src="uploadimage/<%#Eval("Image") %>" /> </div>
                </ItemTemplate>
            </asp:ListView>
							...
							<div class="col-md-3">
								<div class="footer-widget">
									<div class="featured-links">
										...
										<div class="line-dec"></div>
										<div class="fb-page" data-href="https://www.facebook.com/futurevisionmoga016/?fref=ts" data-width="250" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/futurevisionmoga016/?fref=ts" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/futurevisionmoga016/?fref=ts">Official Solutions</a></blockquote></div>
									</div>
								</div>
							</div>
							<div class="col-md-3">
